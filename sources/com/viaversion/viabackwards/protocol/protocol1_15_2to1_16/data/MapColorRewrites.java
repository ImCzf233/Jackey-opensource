...
/* loaded from: Jackey Client b2.jar:com/viaversion/viabackwards/protocol/protocol1_15_2to1_16/data/MapColorRewrites.class */
public final class MapColorRewrites {
    ...
    static {
        ...
        MAPPINGS.put(213, 83);
        MAPPINGS.put(214, 83);
        MAPPINGS.put(Typography.times, 155);
