...
/* loaded from: Jackey Client b2.jar:com/viaversion/viabackwards/protocol/protocol1_11_1to1_12/data/ShoulderTracker.class */
public class ShoulderTracker extends StoredObject {
    ...
    public void update() {
        PacketWrapper wrapper = PacketWrapper.create(ClientboundPackets1_12.CHAT_MESSAGE, (ByteBuf) null, getUser());
    ...
    private String generateString() {
        ...
        if (this.leftShoulder == null) {
            ...
            builder.append("§2§l").append(getName(this.leftShoulder));
        }
        builder.append("§8§l <- §7§lShoulders§8§l -> ");
        if (this.rightShoulder == null) {
            builder.append("§4§lNothing");
        } else {
            builder.append("§2§l").append(getName(this.rightShoulder));
        }
