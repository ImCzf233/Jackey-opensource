...
/* loaded from: Jackey Client b2.jar:com/viaversion/viabackwards/protocol/protocol1_11_1to1_12/data/MapColorMapping.class */
public class MapColorMapping {
    ...
    static {
        ...
        MAPPING.put(194, 43);
        MAPPING.put(195, 107);
        MAPPING.put(Opcode.WIDE, 111);
        MAPPING.put(197, 111);
        MAPPING.put(198, 111);
        MAPPING.put(199, 107);
        MAPPING.put(200, 112);
        MAPPING.put(Opcode.JSR_W, 113);
        MAPPING.put(202, 113);
        MAPPING.put(203, 115);
        MAPPING.put(204, 116);
        MAPPING.put(205, 117);
