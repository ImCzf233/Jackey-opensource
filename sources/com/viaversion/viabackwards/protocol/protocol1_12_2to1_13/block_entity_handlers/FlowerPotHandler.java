...
/* loaded from: Jackey Client b2.jar:com/viaversion/viabackwards/protocol/protocol1_12_2to1_13/block_entity_handlers/FlowerPotHandler.class */
public class FlowerPotHandler implements BackwardsBlockEntityProvider.BackwardsBlockEntityHandler {
    ...
    private static void register(int id, String identifier, byte data) {
        FLOWERS.put(id, (int) new Pair<>(identifier, Byte.valueOf(data)));
    }
