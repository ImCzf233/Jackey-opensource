...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/bukkit/platform/BukkitViaLoader.class */
public class BukkitViaLoader implements ViaPlatformLoader {
    ...
    public void load() {
        ...
        if (serverProtocolVersion < ProtocolVersion.v1_9.getVersion()) {
            ...
            Via.getManager().getProviders().use(HandItemProvider.class, new HandItemProvider() { // from class: com.viaversion.viaversion.bukkit.platform.BukkitViaLoader.1
                ...
                public Item getHandItem(UserConnection info) {
                    ...
                    try {
                        ...
                        Via.getPlatform().getLogger().severe("Error fetching hand item: " + e5.getClass().getName());
