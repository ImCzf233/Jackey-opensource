...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/protocols/protocol1_9to1_8/sounds/SoundEffect.class */
public enum SoundEffect {
    ...
    public static SoundEffect getByName(String name) {
        return effects.get(name.toLowerCase(Locale.ROOT));
    }
