...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/protocols/protocol1_11to1_10/data/PotionColorMapping.class */
public class PotionColorMapping {
    ...
    private static void addRewrite(int oldData, int newData, boolean isInstant) {
        POTIONS.put(oldData, (int) new Pair<>(Integer.valueOf(newData), Boolean.valueOf(isInstant)));
    }
}
