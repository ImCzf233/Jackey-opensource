...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/protocols/protocol1_16to1_15_2/data/TranslationMappings.class */
public class TranslationMappings extends ComponentRewriter {
    ...
    public void processText(JsonElement element) {
        ...
        if (element != null && element.isJsonObject() && (score = (object = element.getAsJsonObject()).getAsJsonObject("score")) != null && !object.has("text") && (value = score.getAsJsonPrimitive("value")) != null) {
            object.remove("score");
