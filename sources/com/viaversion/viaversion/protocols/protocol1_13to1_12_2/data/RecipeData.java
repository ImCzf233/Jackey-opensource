...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/protocols/protocol1_13to1_12_2/data/RecipeData.class */
public class RecipeData {
    ...
    public static void init() {
        ...
        try {
            recipes = (Map) GsonUtil.getGson().fromJson(reader, new TypeToken<Map<String, Recipe>>() { // from class: com.viaversion.viaversion.protocols.protocol1_13to1_12_2.data.RecipeData.1
            }.getType());
        } finally {
            try {
                reader.close();
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/protocols/protocol1_13to1_12_2/data/RecipeData$Recipe.class */
