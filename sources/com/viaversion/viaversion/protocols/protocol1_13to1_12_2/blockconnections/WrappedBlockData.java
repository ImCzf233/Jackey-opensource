...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/protocols/protocol1_13to1_12_2/blockconnections/WrappedBlockData.class */
public class WrappedBlockData {
    ...
    public static WrappedBlockData fromString(String s) {
        ...
        if (array.length > 1) {
            ...
            String[] data = blockData.replace("]", "").split(",");
            for (String d : data) {
                String[] a = d.split("=");
