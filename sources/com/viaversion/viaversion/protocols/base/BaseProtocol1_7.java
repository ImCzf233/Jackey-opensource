...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/protocols/base/BaseProtocol1_7.class */
public class BaseProtocol1_7 extends AbstractProtocol {
    @Override // com.viaversion.viaversion.api.protocol.AbstractProtocol
    protected void registerPackets() {
        registerClientbound((BaseProtocol1_7) ClientboundStatusPackets.STATUS_RESPONSE, new PacketRemapper() { // from class: com.viaversion.viaversion.protocols.base.BaseProtocol1_7.1
            @Override // com.viaversion.viaversion.api.protocol.remapper.PacketRemapper
            public void registerMap() {
                map(Type.STRING);
                handler(new PacketHandler() { // from class: com.viaversion.viaversion.protocols.base.BaseProtocol1_7.1.1
                    ...
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ...
                        try {
                            JsonElement json = (JsonElement) GsonUtil.getGson().fromJson(originalStatus, (Class<Object>) JsonElement.class);
                            ...
                            if (json.isJsonObject()) {
                                if (json.getAsJsonObject().has("version")) {
                                    ...
                                    version = jsonObject;
                                    asJsonObject.add("version", jsonObject);
                                }
                            } else {
                                json = new JsonObject();
                                ...
                                version = jsonObject2;
                                asJsonObject2.add("version", jsonObject2);
                            }
        ...
        registerClientbound((BaseProtocol1_7) ClientboundLoginPackets.GAME_PROFILE, new PacketRemapper() { // from class: com.viaversion.viaversion.protocols.base.BaseProtocol1_7.2
            @Override // com.viaversion.viaversion.api.protocol.remapper.PacketRemapper
            public void registerMap() {
                handler(new PacketHandler() { // from class: com.viaversion.viaversion.protocols.base.BaseProtocol1_7.2.1
                    @Override // com.viaversion.viaversion.api.protocol.remapper.PacketHandler
                    public void handle(PacketWrapper wrapper) throws Exception {
                        ProtocolInfo info = wrapper.user().getProtocolInfo();
        ...
        registerServerbound((BaseProtocol1_7) ServerboundLoginPackets.HELLO, new PacketRemapper() { // from class: com.viaversion.viaversion.protocols.base.BaseProtocol1_7.3
            @Override // com.viaversion.viaversion.api.protocol.remapper.PacketRemapper
            public void registerMap() {
                handler(new PacketHandler() { // from class: com.viaversion.viaversion.protocols.base.BaseProtocol1_7.3.1
                    @Override // com.viaversion.viaversion.api.protocol.remapper.PacketHandler
                    public void handle(PacketWrapper wrapper) throws Exception {
                        int protocol = wrapper.user().getProtocolInfo().getProtocolVersion();
                        if (!Via.getConfig().blockedProtocolVersions().contains(protocol) || !wrapper.user().getChannel().isOpen() || !wrapper.user().shouldApplyBlockProtocol()) {
                            return;
                        }
