...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/ViaManagerImpl.class */
public class ViaManagerImpl implements ViaManager {
    ...
    private final void unsupportedSoftwareWarning() {
        ...
        for (UnsupportedSoftware software : this.platform.getUnsupportedSoftwareClasses()) {
            if (software.findMatch()) {
                ...
                this.platform.getLogger().severe("We strongly advise against using " + software.getName() + CallSiteDescriptor.TOKEN_DELIMITER);
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/ViaManagerImpl$ViaManagerBuilder.class */
