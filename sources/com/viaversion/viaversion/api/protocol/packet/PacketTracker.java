...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/api/protocol/packet/PacketTracker.class */
public class PacketTracker {
    ...
    public boolean exceedsMaxPPS() {
        ...
        if (conf.getMaxPPS() > 0 && this.packetsPerSecond >= conf.getMaxPPS()) {
            ...
            return true;
        } else if (conf.getMaxWarnings() > 0 && conf.getTrackingPeriod() > 0) {
