...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/api/protocol/version/ProtocolVersion.class */
public class ProtocolVersion {
    ...
    public static final ProtocolVersion v1_11 = register(TokenId.FINAL, "1.11");
    public static final ProtocolVersion v1_11_1 = register((int) TokenId.FINALLY, "1.11.1/2", new VersionRange("1.11", 1, 2));
    public static final ProtocolVersion v1_12 = register(TokenId.STATIC, "1.12");
    public static final ProtocolVersion v1_12_1 = register(TokenId.SYNCHRONIZED, "1.12.1");
    public static final ProtocolVersion v1_12_2 = register(TokenId.THROW, "1.12.2");
    public static final ProtocolVersion v1_13 = register(393, "1.13");
    public static final ProtocolVersion v1_13_1 = register(TokenId.CharConstant, "1.13.1");
    public static final ProtocolVersion v1_13_2 = register(TokenId.FloatConstant, "1.13.2");
    ...
    public static ProtocolVersion register(int version, int snapshotVersion, String name, VersionRange versionRange) {
        ...
        VERSIONS.put(protocol.getVersion(), (int) protocol);
        if (protocol.isSnapshot()) {
            VERSIONS.put(protocol.getFullSnapshotVersion(), (int) protocol);
        }
        return protocol;
    }
    ...
    public static ProtocolVersion getClosest(String protocol) {
        ...
        while (it.hasNext()) {
            ProtocolVersion version = it.next();
