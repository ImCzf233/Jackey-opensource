...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/api/minecraft/entities/Entity1_10Types.class */
public class Entity1_10Types {
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/api/minecraft/entities/Entity1_10Types$EntityType.class */
    public enum EntityType implements com.viaversion.viaversion.api.minecraft.entities.EntityType {
        ...
        static {
            ...
            for (EntityType type : values()) {
                TYPES.put(Integer.valueOf(type.f44id), type);
            }
        }
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/api/minecraft/entities/Entity1_10Types$ObjectType.class */
    public enum ObjectType implements com.viaversion.viaversion.api.minecraft.entities.ObjectType {
        ...
        static {
            ...
            for (ObjectType type : values()) {
                TYPES.put(Integer.valueOf(type.f45id), type);
            }
        }
        ...
        @Override // com.viaversion.viaversion.api.minecraft.entities.ObjectType
        public int getId() {
            return this.f45id;
        }
