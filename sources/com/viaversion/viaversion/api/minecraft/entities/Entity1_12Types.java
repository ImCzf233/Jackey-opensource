...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/api/minecraft/entities/Entity1_12Types.class */
public class Entity1_12Types {
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/api/minecraft/entities/Entity1_12Types$EntityType.class */
    public enum EntityType implements com.viaversion.viaversion.api.minecraft.entities.EntityType {
        ...
        static {
            ...
            for (EntityType type : values()) {
                TYPES.put(Integer.valueOf(type.f48id), type);
            }
        }
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/api/minecraft/entities/Entity1_12Types$ObjectType.class */
    public enum ObjectType implements com.viaversion.viaversion.api.minecraft.entities.ObjectType {
        ...
        static {
            ...
            for (ObjectType type : values()) {
                TYPES.put(Integer.valueOf(type.f49id), type);
            }
        }
