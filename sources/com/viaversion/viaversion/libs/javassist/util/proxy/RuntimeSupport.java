...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/util/proxy/RuntimeSupport.class */
public class RuntimeSupport {
    public static MethodHandler default_interceptor = new DefaultMethodHandler();

    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/util/proxy/RuntimeSupport$DefaultMethodHandler.class */
    static class DefaultMethodHandler implements MethodHandler, Serializable {
        ...
        @Override // com.viaversion.viaversion.libs.javassist.util.proxy.MethodHandler
    ...
    private static void error(Class<?> clazz, String name, String desc) {
        throw new RuntimeException("not found " + name + CallSiteDescriptor.TOKEN_DELIMITER + desc + " in " + clazz.getName());
    }
