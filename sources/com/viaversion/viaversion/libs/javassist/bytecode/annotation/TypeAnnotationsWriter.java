...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/bytecode/annotation/TypeAnnotationsWriter.class */
public class TypeAnnotationsWriter extends AnnotationsWriter {
    public TypeAnnotationsWriter(OutputStream os, ConstPool cp) {
        super(os, cp);
    }

    @Override // com.viaversion.viaversion.libs.javassist.bytecode.annotation.AnnotationsWriter
