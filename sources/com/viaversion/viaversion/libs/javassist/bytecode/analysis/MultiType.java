...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/bytecode/analysis/MultiType.class */
public class MultiType extends Type {
    ...
    public String toString() {
        ...
        if (this.potentialClass != null) {
            buffer.append(Marker.ANY_MARKER).append(this.potentialClass.toString());
        } else {
