...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/bytecode/InnerClassesAttribute.class */
public class InnerClassesAttribute extends AttributeInfo {
    public static final String tag = "InnerClasses";

    public InnerClassesAttribute(ConstPool cp, int n, DataInputStream in) throws IOException {
        super(cp, n, in);
    }
