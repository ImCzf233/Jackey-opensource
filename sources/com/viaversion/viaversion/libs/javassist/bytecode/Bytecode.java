...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/bytecode/Bytecode.class */
public class Bytecode extends ByteVector implements Cloneable, Opcode {
    ...
    @Override // com.viaversion.viaversion.libs.javassist.bytecode.ByteVector
    ...
    public int read32bit(int offset) {
        ...
        return (v1 << 16) + (v2 & CharCompanionObject.MAX_VALUE);
    }
