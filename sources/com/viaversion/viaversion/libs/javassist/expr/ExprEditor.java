...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/expr/ExprEditor.class */
public class ExprEditor {
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/expr/ExprEditor$NewOp.class */
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/expr/ExprEditor$LoopContext.class */
    public static final class LoopContext {
        int maxLocals;
        int maxStack = 0;
        NewOp newList = null;

        public LoopContext(int locals) {
