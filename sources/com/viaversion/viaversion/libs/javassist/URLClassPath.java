...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/javassist/URLClassPath.class */
public class URLClassPath implements ClassPath {
    ...
    public String toString() {
        return this.hostname + CallSiteDescriptor.TOKEN_DELIMITER + this.port + this.directory;
    }
