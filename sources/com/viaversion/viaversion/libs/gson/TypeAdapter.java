...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/gson/TypeAdapter.class */
public abstract class TypeAdapter<T> {
    ...
    public final TypeAdapter<T> nullSafe() {
        return new TypeAdapter<T>() { // from class: com.viaversion.viaversion.libs.gson.TypeAdapter.1
