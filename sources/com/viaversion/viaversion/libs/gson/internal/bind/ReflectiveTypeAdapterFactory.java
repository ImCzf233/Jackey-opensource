...
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/gson/internal/bind/ReflectiveTypeAdapterFactory.class */
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private BoundField createBoundField(final Gson context, final Field field, String name, final TypeToken<?> fieldType, boolean serialize, boolean deserialize) {
        ...
        return new BoundField(name, serialize, deserialize) { // from class: com.viaversion.viaversion.libs.gson.internal.bind.ReflectiveTypeAdapterFactory.1
            @Override // com.viaversion.viaversion.libs.gson.internal.bind.ReflectiveTypeAdapterFactory.BoundField
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/gson/internal/bind/ReflectiveTypeAdapterFactory$BoundField.class */
    ...
    /* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/gson/internal/bind/ReflectiveTypeAdapterFactory$Adapter.class */
