...
/* compiled from: FloatBinaryTag.java */
@Debug.Renderer(text = "String.valueOf(this.value) + \"f\"", hasChildren = "false")
/* loaded from: Jackey Client b2.jar:com/viaversion/viaversion/libs/kyori/adventure/nbt/FloatBinaryTagImpl.class */
public final class FloatBinaryTagImpl extends AbstractBinaryTag implements FloatBinaryTag {
    private final float value;

    public FloatBinaryTagImpl(final float value) {
        this.value = value;
    }

    @Override // com.viaversion.viaversion.libs.kyori.adventure.nbt.FloatBinaryTag
    public float value() {
        return this.value;
    }
    ...
    public Stream<? extends ExaminableProperty> examinableProperties() {
        return Stream.of(ExaminableProperty.m94of("value", this.value));
    }
}
