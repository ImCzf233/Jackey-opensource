...
/* loaded from: Jackey Client b2.jar:com/thealtening/api/data/AccountData.class */
public class AccountData {
    ...
    public String toString() {
        return String.format("AccountData[%s:%s:%s:%s]", this.token, this.username, this.password, Boolean.valueOf(this.limit));
    }
