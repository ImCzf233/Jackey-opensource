...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSMW.class */
public class SILSMW<K, V> extends SILS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SILSMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
