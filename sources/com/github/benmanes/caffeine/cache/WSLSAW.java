...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSAW.class */
class WSLSAW<K, V> extends WSLSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSLSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
