...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIMWW.class */
class SIMWW<K, V> extends SIMW<K, V> {
    ...
    public SIMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
