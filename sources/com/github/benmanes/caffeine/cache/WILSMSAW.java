...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSMSAW.class */
class WILSMSAW<K, V> extends WILSMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WILSMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
