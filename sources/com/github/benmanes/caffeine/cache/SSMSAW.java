...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSMSAW.class */
class SSMSAW<K, V> extends SSMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
