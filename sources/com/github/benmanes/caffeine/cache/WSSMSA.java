...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSMSA.class */
public class WSSMSA<K, V> extends WSSMS<K, V> {
    final Ticker ticker;
    ...
    public WSSMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
