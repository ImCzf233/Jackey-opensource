...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLMWAW.class */
class WSLMWAW<K, V> extends WSLMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSLMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
