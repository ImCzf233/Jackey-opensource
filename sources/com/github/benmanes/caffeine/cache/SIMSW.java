...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIMSW.class */
class SIMSW<K, V> extends SIMS<K, V> {
    ...
    public SIMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
