...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLA.class */
public class SSLA<K, V> extends SSL<K, V> {
    final Ticker ticker;
    ...
    public SSLA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
