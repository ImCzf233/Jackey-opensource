...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIMW.class */
public class SIMW<K, V> extends C0023SI<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SIMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
