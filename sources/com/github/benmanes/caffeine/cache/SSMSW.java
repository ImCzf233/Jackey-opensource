...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSMSW.class */
class SSMSW<K, V> extends SSMS<K, V> {
    ...
    public SSMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
