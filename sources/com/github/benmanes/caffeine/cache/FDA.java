...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/FDA.class */
public class FDA<K, V> extends C0007FD<K, V> {
    protected static final long ACCESS_TIME_OFFSET = UnsafeAccess.objectFieldOffset(FDA.class, LocalCacheFactory.ACCESS_TIME);
    ...
    public FDA(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, ACCESS_TIME_OFFSET, now);
    }

    public FDA(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
