...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSW.class */
class WSW<K, V> extends C0026WS<K, V> {
    final Ticker ticker;
    ...
    public WSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
