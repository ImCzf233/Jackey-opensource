...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISMWA.class */
public class WISMWA<K, V> extends WISMW<K, V> {
    final Ticker ticker;
    ...
    public WISMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
