...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIS.class */
public class SIS<K, V> extends C0023SI<K, V> {
    final StatsCounter statsCounter;

    public SIS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
