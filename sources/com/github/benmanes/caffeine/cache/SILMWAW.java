...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILMWAW.class */
class SILMWAW<K, V> extends SILMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SILMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
