...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSMSW.class */
class WSLSMSW<K, V> extends WSLSMS<K, V> {
    ...
    public WSLSMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
