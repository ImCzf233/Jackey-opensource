...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLMSA.class */
public class WSLMSA<K, V> extends WSLMS<K, V> {
    final Ticker ticker;
    ...
    public WSLMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
