...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILW.class */
class WILW<K, V> extends WIL<K, V> {
    ...
    public WILW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
