...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIAW.class */
class WIAW<K, V> extends WIA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WIAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
