...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLMW.class */
public class WSLMW<K, V> extends WSL<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WSLMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
