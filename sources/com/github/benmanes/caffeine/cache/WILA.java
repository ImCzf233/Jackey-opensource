...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILA.class */
public class WILA<K, V> extends WIL<K, V> {
    final Ticker ticker;
    ...
    public WILA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
