...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSMWAW.class */
class SSLSMWAW<K, V> extends SSLSMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSLSMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
