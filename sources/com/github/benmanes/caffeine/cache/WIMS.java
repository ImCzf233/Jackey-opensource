...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIMS.class */
public class WIMS<K, V> extends C0025WI<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WIMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
