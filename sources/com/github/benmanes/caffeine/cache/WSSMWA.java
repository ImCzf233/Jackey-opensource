...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSMWA.class */
public class WSSMWA<K, V> extends WSSMW<K, V> {
    final Ticker ticker;
    ...
    public WSSMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
