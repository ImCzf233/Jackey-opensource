...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSMSA.class */
public class SSMSA<K, V> extends SSMS<K, V> {
    final Ticker ticker;
    ...
    public SSMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
