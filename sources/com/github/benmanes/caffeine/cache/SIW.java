...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIW.class */
class SIW<K, V> extends C0023SI<K, V> {
    final Ticker ticker;
    ...
    public SIW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
