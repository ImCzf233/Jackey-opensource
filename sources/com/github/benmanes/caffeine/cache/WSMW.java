...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSMW.class */
public class WSMW<K, V> extends C0026WS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WSMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
