...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSW.class */
class WSLSW<K, V> extends WSLS<K, V> {
    ...
    public WSLSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
