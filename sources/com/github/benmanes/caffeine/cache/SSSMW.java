...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSMW.class */
public class SSSMW<K, V> extends SSS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SSSMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
