...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILMWA.class */
public class SILMWA<K, V> extends SILMW<K, V> {
    final Ticker ticker;
    ...
    public SILMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
