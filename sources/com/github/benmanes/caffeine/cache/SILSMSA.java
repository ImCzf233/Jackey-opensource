...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSMSA.class */
public class SILSMSA<K, V> extends SILSMS<K, V> {
    final Ticker ticker;
    ...
    public SILSMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
