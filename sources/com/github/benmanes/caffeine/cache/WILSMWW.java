...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSMWW.class */
class WILSMWW<K, V> extends WILSMW<K, V> {
    ...
    public WILSMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
