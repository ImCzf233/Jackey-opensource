...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILMSW.class */
class SILMSW<K, V> extends SILMS<K, V> {
    ...
    public SILMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
