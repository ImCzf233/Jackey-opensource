...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSMWW.class */
class SSSMWW<K, V> extends SSSMW<K, V> {
    ...
    public SSSMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
