...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIMW.class */
public class WIMW<K, V> extends C0025WI<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WIMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
