...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILMS.class */
public class SILMS<K, V> extends SIL<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SILMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
