...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILMSAW.class */
class SILMSAW<K, V> extends SILMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SILMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
