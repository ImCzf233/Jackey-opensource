...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIMSA.class */
public class WIMSA<K, V> extends WIMS<K, V> {
    final Ticker ticker;
    ...
    public WIMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
