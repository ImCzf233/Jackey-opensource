...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLMSAW.class */
class WSLMSAW<K, V> extends WSLMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSLMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
