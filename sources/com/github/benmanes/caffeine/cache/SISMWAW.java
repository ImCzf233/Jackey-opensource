...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISMWAW.class */
class SISMWAW<K, V> extends SISMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SISMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
