...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/PDAR.class */
public class PDAR<K, V> extends PDA<K, V> {
    ...
    public PDAR(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, WRITE_TIME_OFFSET, now);
    }

    public PDAR(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
