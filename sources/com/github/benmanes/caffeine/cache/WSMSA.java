...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSMSA.class */
public class WSMSA<K, V> extends WSMS<K, V> {
    final Ticker ticker;
    ...
    public WSMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
