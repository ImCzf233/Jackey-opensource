...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIAW.class */
class SIAW<K, V> extends SIA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SIAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
