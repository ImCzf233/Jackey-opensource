...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSMWW.class */
class SSMWW<K, V> extends SSMW<K, V> {
    ...
    public SSMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
