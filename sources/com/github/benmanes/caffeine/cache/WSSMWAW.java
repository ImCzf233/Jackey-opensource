...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSMWAW.class */
class WSSMWAW<K, V> extends WSSMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSSMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
