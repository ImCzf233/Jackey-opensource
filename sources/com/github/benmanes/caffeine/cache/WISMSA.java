...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISMSA.class */
public class WISMSA<K, V> extends WISMS<K, V> {
    final Ticker ticker;
    ...
    public WISMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
