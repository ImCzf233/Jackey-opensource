...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIMSAW.class */
class WIMSAW<K, V> extends WIMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WIMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
