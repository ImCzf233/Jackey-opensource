...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/PDW.class */
public class PDW<K, V> extends C0015PD<K, V> {
    protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(PDW.class, LocalCacheFactory.WRITE_TIME);
    ...
    public PDW(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, WRITE_TIME_OFFSET, now);
    }

    public PDW(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
