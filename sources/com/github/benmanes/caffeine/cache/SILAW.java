...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILAW.class */
class SILAW<K, V> extends SILA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SILAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
