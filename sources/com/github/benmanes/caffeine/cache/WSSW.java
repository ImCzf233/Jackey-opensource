...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSW.class */
class WSSW<K, V> extends WSS<K, V> {
    ...
    public WSSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
