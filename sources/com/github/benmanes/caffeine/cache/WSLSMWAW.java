...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSMWAW.class */
class WSLSMWAW<K, V> extends WSLSMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSLSMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
