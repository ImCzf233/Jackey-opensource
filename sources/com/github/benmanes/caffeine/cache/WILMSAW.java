...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILMSAW.class */
class WILMSAW<K, V> extends WILMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WILMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
