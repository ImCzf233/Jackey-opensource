...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSMWAW.class */
class SSMWAW<K, V> extends SSMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
