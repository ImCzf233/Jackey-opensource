...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSMWW.class */
class WSSMWW<K, V> extends WSSMW<K, V> {
    ...
    public WSSMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
