...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSW.class */
class SILSW<K, V> extends SILS<K, V> {
    ...
    public SILSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
