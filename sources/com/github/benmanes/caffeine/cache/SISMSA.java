...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISMSA.class */
public class SISMSA<K, V> extends SISMS<K, V> {
    final Ticker ticker;
    ...
    public SISMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
