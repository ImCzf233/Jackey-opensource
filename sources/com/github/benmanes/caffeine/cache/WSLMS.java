...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLMS.class */
public class WSLMS<K, V> extends WSL<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WSLMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
