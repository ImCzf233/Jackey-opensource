...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/FDW.class */
public class FDW<K, V> extends C0007FD<K, V> {
    protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(FDW.class, LocalCacheFactory.WRITE_TIME);
    ...
    public FDW(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, WRITE_TIME_OFFSET, now);
    }

    public FDW(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
