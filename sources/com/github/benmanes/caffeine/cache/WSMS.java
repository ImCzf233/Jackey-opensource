...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSMS.class */
public class WSMS<K, V> extends C0026WS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WSMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
