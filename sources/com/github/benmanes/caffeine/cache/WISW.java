...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISW.class */
class WISW<K, V> extends WIS<K, V> {
    ...
    public WISW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
