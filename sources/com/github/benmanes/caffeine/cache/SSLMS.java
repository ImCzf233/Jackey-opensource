...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLMS.class */
public class SSLMS<K, V> extends SSL<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SSLMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
