...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSMWAW.class */
class WSMWAW<K, V> extends WSMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
