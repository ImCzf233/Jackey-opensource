...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSMWAW.class */
class WILSMWAW<K, V> extends WILSMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WILSMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
