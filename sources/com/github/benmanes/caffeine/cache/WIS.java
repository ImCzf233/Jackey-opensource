...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIS.class */
public class WIS<K, V> extends C0025WI<K, V> {
    final StatsCounter statsCounter;

    public WIS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
