...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSW.class */
class WILSW<K, V> extends WILS<K, V> {
    ...
    public WILSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
