...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/FSA.class */
public class FSA<K, V> extends C0008FS<K, V> {
    protected static final long ACCESS_TIME_OFFSET = UnsafeAccess.objectFieldOffset(FSA.class, LocalCacheFactory.ACCESS_TIME);
    ...
    public FSA(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, ACCESS_TIME_OFFSET, now);
    }

    public FSA(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
    ...
    @Override // com.github.benmanes.caffeine.cache.C0008FS, com.github.benmanes.caffeine.cache.NodeFactory
