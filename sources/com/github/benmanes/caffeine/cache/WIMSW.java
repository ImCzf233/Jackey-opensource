...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIMSW.class */
class WIMSW<K, V> extends WIMS<K, V> {
    ...
    public WIMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
