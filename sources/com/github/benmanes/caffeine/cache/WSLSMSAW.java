...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSMSAW.class */
class WSLSMSAW<K, V> extends WSLSMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSLSMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
