...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISMSAW.class */
class SISMSAW<K, V> extends SISMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SISMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
