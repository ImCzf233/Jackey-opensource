...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLMWA.class */
public class WSLMWA<K, V> extends WSLMW<K, V> {
    final Ticker ticker;
    ...
    public WSLMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
