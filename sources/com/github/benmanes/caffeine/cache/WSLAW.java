...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLAW.class */
class WSLAW<K, V> extends WSLA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSLAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
