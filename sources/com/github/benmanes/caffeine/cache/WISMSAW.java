...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISMSAW.class */
class WISMSAW<K, V> extends WISMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WISMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
