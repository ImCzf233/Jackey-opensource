...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSMSW.class */
class WILSMSW<K, V> extends WILSMS<K, V> {
    ...
    public WILSMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
