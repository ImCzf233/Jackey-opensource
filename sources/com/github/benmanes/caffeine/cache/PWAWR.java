...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/PWAWR.class */
public class PWAWR<K, V> extends PWAW<K, V> {
    public PWAWR() {
    }

    public PWAWR(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
    }

    public PWAWR(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(keyReference, value, valueReferenceQueue, weight, now);
    }

    @Override // com.github.benmanes.caffeine.cache.PWAW, com.github.benmanes.caffeine.cache.PWA, com.github.benmanes.caffeine.cache.Node
