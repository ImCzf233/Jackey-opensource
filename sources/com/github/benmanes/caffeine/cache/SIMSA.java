...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIMSA.class */
public class SIMSA<K, V> extends SIMS<K, V> {
    final Ticker ticker;
    ...
    public SIMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
