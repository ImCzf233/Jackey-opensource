...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLA.class */
public class WSLA<K, V> extends WSL<K, V> {
    final Ticker ticker;
    ...
    public WSLA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
