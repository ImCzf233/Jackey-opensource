...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSA.class */
public class WSSA<K, V> extends WSS<K, V> {
    final Ticker ticker;
    ...
    public WSSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
