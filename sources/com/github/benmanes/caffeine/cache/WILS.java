...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILS.class */
public class WILS<K, V> extends WIL<K, V> {
    final StatsCounter statsCounter;

    public WILS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
