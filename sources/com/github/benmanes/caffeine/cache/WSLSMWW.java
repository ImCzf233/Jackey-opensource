...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSMWW.class */
class WSLSMWW<K, V> extends WSLSMW<K, V> {
    ...
    public WSLSMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
