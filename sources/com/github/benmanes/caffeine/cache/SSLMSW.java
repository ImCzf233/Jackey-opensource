...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLMSW.class */
class SSLMSW<K, V> extends SSLMS<K, V> {
    ...
    public SSLMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
