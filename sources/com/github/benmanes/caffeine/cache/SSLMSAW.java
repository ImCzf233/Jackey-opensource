...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLMSAW.class */
class SSLMSAW<K, V> extends SSLMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSLMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
