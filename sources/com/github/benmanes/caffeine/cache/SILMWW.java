...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILMWW.class */
class SILMWW<K, V> extends SILMW<K, V> {
    ...
    public SILMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
