...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSMWW.class */
class SILSMWW<K, V> extends SILSMW<K, V> {
    ...
    public SILSMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
