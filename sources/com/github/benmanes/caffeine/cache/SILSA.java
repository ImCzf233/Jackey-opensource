...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSA.class */
public class SILSA<K, V> extends SILS<K, V> {
    final Ticker ticker;
    ...
    public SILSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
