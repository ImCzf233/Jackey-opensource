...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISMSW.class */
class SISMSW<K, V> extends SISMS<K, V> {
    ...
    public SISMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
