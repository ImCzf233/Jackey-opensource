...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIA.class */
public class SIA<K, V> extends C0023SI<K, V> {
    final Ticker ticker;
    ...
    public SIA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
