...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISW.class */
class SISW<K, V> extends SIS<K, V> {
    ...
    public SISW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
