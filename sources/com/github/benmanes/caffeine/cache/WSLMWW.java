...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLMWW.class */
class WSLMWW<K, V> extends WSLMW<K, V> {
    ...
    public WSLMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
