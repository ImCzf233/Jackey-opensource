...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSMW.class */
public class SSLSMW<K, V> extends SSLS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SSLSMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
