...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLMSA.class */
public class SSLMSA<K, V> extends SSLMS<K, V> {
    final Ticker ticker;
    ...
    public SSLMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
