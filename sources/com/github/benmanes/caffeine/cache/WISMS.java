...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISMS.class */
public class WISMS<K, V> extends WIS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WISMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
