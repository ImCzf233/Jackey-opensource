...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSAW.class */
class WSAW<K, V> extends WSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
