...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSMW.class */
public class SSMW<K, V> extends C0024SS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SSMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
