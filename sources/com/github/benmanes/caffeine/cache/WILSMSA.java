...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSMSA.class */
public class WILSMSA<K, V> extends WILSMS<K, V> {
    final Ticker ticker;
    ...
    public WILSMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
