...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISMWA.class */
public class SISMWA<K, V> extends SISMW<K, V> {
    final Ticker ticker;
    ...
    public SISMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
