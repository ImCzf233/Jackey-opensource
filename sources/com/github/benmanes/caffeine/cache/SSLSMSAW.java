...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSMSAW.class */
class SSLSMSAW<K, V> extends SSLSMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSLSMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
