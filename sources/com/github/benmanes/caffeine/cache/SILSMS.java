...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSMS.class */
public class SILSMS<K, V> extends SILS<K, V> {
    ...
    public SILSMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
