...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSW.class */
class SSW<K, V> extends C0024SS<K, V> {
    final Ticker ticker;
    ...
    public SSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
