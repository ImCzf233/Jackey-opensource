...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLMWAW.class */
class SSLMWAW<K, V> extends SSLMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSLMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
