...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSAW.class */
class WSSAW<K, V> extends WSSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
