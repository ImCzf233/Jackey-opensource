...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSMS.class */
public class WSLSMS<K, V> extends WSLS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WSLSMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
