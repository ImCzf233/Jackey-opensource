...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSW.class */
class SSLSW<K, V> extends SSLS<K, V> {
    ...
    public SSLSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
