...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILS.class */
public class SILS<K, V> extends SIL<K, V> {
    final StatsCounter statsCounter;

    public SILS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
