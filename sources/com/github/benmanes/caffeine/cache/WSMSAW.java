...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSMSAW.class */
class WSMSAW<K, V> extends WSMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
