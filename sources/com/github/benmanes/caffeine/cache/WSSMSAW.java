...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSMSAW.class */
class WSSMSAW<K, V> extends WSSMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WSSMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
