...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILMSA.class */
public class WILMSA<K, V> extends WILMS<K, V> {
    final Ticker ticker;
    ...
    public WILMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
