...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIMS.class */
public class SIMS<K, V> extends C0023SI<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SIMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
