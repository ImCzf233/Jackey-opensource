...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSMSW.class */
class WSMSW<K, V> extends WSMS<K, V> {
    ...
    public WSMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
