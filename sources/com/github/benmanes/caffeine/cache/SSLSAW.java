...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSAW.class */
class SSLSAW<K, V> extends SSLSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSLSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
