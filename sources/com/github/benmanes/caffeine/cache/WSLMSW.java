...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLMSW.class */
class WSLMSW<K, V> extends WSLMS<K, V> {
    ...
    public WSLMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
