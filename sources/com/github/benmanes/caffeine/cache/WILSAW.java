...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSAW.class */
class WILSAW<K, V> extends WILSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WILSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
