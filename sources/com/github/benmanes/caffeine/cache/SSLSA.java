...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSA.class */
public class SSLSA<K, V> extends SSLS<K, V> {
    final Ticker ticker;
    ...
    public SSLSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
