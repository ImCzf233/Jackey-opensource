...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/PSA.class */
public class PSA<K, V> extends C0016PS<K, V> {
    protected static final long ACCESS_TIME_OFFSET = UnsafeAccess.objectFieldOffset(PSA.class, LocalCacheFactory.ACCESS_TIME);
    ...
    public PSA(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, ACCESS_TIME_OFFSET, now);
    }

    public PSA(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
