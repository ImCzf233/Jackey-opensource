...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIMWA.class */
public class SIMWA<K, V> extends SIMW<K, V> {
    final Ticker ticker;
    ...
    public SIMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
