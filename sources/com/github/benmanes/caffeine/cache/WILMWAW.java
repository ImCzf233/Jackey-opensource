...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILMWAW.class */
class WILMWAW<K, V> extends WILMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WILMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
