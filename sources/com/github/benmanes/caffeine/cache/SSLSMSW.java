...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSMSW.class */
class SSLSMSW<K, V> extends SSLSMS<K, V> {
    ...
    public SSLSMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
