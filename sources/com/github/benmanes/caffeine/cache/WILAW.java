...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILAW.class */
class WILAW<K, V> extends WILA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WILAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
