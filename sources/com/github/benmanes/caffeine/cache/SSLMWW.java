...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLMWW.class */
class SSLMWW<K, V> extends SSLMW<K, V> {
    ...
    public SSLMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
