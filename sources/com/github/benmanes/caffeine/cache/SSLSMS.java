...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSMS.class */
public class SSLSMS<K, V> extends SSLS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SSLSMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
