...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSMSW.class */
class SILSMSW<K, V> extends SILSMS<K, V> {
    ...
    public SILSMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
