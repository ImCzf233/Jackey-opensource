...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSMWA.class */
public class WSLSMWA<K, V> extends WSLSMW<K, V> {
    final Ticker ticker;
    ...
    public WSLSMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
