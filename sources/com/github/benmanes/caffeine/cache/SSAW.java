...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSAW.class */
class SSAW<K, V> extends SSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
