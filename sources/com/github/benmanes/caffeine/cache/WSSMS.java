...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSMS.class */
public class WSSMS<K, V> extends WSS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WSSMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
