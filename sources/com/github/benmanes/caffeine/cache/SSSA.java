...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSA.class */
public class SSSA<K, V> extends SSS<K, V> {
    final Ticker ticker;
    ...
    public SSSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
