...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISMWAW.class */
class WISMWAW<K, V> extends WISMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WISMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
