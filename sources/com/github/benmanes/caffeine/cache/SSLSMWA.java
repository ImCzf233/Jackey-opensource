...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSMWA.class */
public class SSLSMWA<K, V> extends SSLSMW<K, V> {
    final Ticker ticker;
    ...
    public SSLSMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
    ...
    @Override // com.github.benmanes.caffeine.cache.SSLSMW, com.github.benmanes.caffeine.cache.BoundedLocalCache
