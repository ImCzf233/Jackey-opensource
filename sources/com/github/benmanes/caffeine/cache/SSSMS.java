...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSMS.class */
public class SSSMS<K, V> extends SSS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SSSMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
