...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSA.class */
public class WSLSA<K, V> extends WSLS<K, V> {
    final Ticker ticker;
    ...
    public WSLSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
