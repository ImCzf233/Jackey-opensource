...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSMSW.class */
class WSSMSW<K, V> extends WSSMS<K, V> {
    ...
    public WSSMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
