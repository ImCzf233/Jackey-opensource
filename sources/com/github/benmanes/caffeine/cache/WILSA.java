...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSA.class */
public class WILSA<K, V> extends WILS<K, V> {
    final Ticker ticker;
    ...
    public WILSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
