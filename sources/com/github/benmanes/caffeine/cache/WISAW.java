...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISAW.class */
class WISAW<K, V> extends WISA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public WISAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
