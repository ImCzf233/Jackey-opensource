...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILMW.class */
public class WILMW<K, V> extends WIL<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WILMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
