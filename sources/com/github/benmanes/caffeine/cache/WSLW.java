...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLW.class */
class WSLW<K, V> extends WSL<K, V> {
    ...
    public WSLW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
