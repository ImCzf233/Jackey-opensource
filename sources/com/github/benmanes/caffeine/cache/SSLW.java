...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLW.class */
class SSLW<K, V> extends SSL<K, V> {
    ...
    public SSLW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
