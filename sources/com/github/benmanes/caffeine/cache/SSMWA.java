...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSMWA.class */
public class SSMWA<K, V> extends SSMW<K, V> {
    final Ticker ticker;
    ...
    public SSMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
    ...
    @Override // com.github.benmanes.caffeine.cache.SSMW, com.github.benmanes.caffeine.cache.BoundedLocalCache
