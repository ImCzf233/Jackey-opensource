...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSMSW.class */
class SSSMSW<K, V> extends SSSMS<K, V> {
    ...
    public SSSMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
