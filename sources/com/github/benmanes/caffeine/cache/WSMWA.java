...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSMWA.class */
public class WSMWA<K, V> extends WSMW<K, V> {
    final Ticker ticker;
    ...
    public WSMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
