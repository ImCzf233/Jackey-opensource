...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSMS.class */
public class SSMS<K, V> extends C0024SS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SSMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
