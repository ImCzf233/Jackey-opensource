...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILA.class */
public class SILA<K, V> extends SIL<K, V> {
    final Ticker ticker;
    ...
    public SILA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
