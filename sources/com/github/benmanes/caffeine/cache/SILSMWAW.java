...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSMWAW.class */
class SILSMWAW<K, V> extends SILSMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SILSMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
