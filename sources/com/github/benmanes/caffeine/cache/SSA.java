...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSA.class */
public class SSA<K, V> extends C0024SS<K, V> {
    final Ticker ticker;
    ...
    public SSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
