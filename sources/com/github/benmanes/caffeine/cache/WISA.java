...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISA.class */
public class WISA<K, V> extends WIS<K, V> {
    final Ticker ticker;
    ...
    public WISA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
