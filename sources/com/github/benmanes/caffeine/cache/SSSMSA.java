...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSMSA.class */
public class SSSMSA<K, V> extends SSSMS<K, V> {
    final Ticker ticker;
    ...
    public SSSMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
    ...
    @Override // com.github.benmanes.caffeine.cache.SSSMS, com.github.benmanes.caffeine.cache.BoundedLocalCache
