...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILSAW.class */
class SILSAW<K, V> extends SILSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SILSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
