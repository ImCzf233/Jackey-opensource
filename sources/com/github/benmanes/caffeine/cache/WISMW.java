...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISMW.class */
public class WISMW<K, V> extends WIS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WISMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
