...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/PWW.class */
public class PWW<K, V> extends C0017PW<K, V> {
    protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(PWW.class, LocalCacheFactory.WRITE_TIME);
    ...
    public PWW(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, WRITE_TIME_OFFSET, now);
    }

    public PWW(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
