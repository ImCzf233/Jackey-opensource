...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSMWA.class */
public class SSSMWA<K, V> extends SSSMW<K, V> {
    final Ticker ticker;
    ...
    public SSSMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
    ...
    @Override // com.github.benmanes.caffeine.cache.SSSMW, com.github.benmanes.caffeine.cache.BoundedLocalCache
