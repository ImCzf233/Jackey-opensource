...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILMWA.class */
public class WILMWA<K, V> extends WILMW<K, V> {
    final Ticker ticker;
    ...
    public WILMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
