...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSMS.class */
public class WILSMS<K, V> extends WILS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WILSMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
