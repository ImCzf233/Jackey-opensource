...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSA.class */
public class WSA<K, V> extends C0026WS<K, V> {
    final Ticker ticker;
    ...
    public WSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
