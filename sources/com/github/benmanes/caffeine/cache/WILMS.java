...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILMS.class */
public class WILMS<K, V> extends WIL<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WILMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
