...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/FWWR.class */
public class FWWR<K, V> extends FWW<K, V> {
    public FWWR() {
    }

    public FWWR(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
    }

    public FWWR(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
