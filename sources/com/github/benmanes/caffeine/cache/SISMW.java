...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISMW.class */
public class SISMW<K, V> extends SIS<K, V> {
    ...
    public SISMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
