...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIMWA.class */
public class WIMWA<K, V> extends WIMW<K, V> {
    final Ticker ticker;
    ...
    public WIMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
