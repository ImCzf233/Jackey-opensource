...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIA.class */
public class WIA<K, V> extends C0025WI<K, V> {
    final Ticker ticker;
    ...
    public WIA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
