...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILMWW.class */
class WILMWW<K, V> extends WILMW<K, V> {
    ...
    public WILMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
