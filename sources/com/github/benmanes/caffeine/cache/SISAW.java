...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISAW.class */
class SISAW<K, V> extends SISA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SISAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
