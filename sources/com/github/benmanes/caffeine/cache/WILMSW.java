...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILMSW.class */
class WILMSW<K, V> extends WILMS<K, V> {
    ...
    public WILMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
