...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISMSW.class */
class WISMSW<K, V> extends WISMS<K, V> {
    ...
    public WISMSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
