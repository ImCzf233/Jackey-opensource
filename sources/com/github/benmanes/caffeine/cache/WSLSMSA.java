...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSLSMSA.class */
public class WSLSMSA<K, V> extends WSLSMS<K, V> {
    final Ticker ticker;
    ...
    public WSLSMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
