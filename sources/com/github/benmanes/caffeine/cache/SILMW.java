...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILMW.class */
public class SILMW<K, V> extends SIL<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SILMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
