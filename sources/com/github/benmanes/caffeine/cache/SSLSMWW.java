...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSMWW.class */
class SSLSMWW<K, V> extends SSLSMW<K, V> {
    ...
    public SSLSMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
