...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLMWA.class */
public class SSLMWA<K, V> extends SSLMW<K, V> {
    final Ticker ticker;
    ...
    public SSLMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
    ...
    @Override // com.github.benmanes.caffeine.cache.SSLMW, com.github.benmanes.caffeine.cache.BoundedLocalCache
