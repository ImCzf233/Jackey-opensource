...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/FWW.class */
public class FWW<K, V> extends C0009FW<K, V> {
    protected static final long WRITE_TIME_OFFSET = UnsafeAccess.objectFieldOffset(FWW.class, LocalCacheFactory.WRITE_TIME);
    ...
    public FWW(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, WRITE_TIME_OFFSET, now);
    }

    public FWW(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
