...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WIMWW.class */
class WIMWW<K, V> extends WIMW<K, V> {
    ...
    public WIMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
