...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLMW.class */
public class SSLMW<K, V> extends SSL<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SSLMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
