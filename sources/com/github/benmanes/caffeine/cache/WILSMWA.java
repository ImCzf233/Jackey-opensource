...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSMWA.class */
public class WILSMWA<K, V> extends WILSMW<K, V> {
    final Ticker ticker;
    ...
    public WILSMWA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
