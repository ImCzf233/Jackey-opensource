...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLSMSA.class */
public class SSLSMSA<K, V> extends SSLSMS<K, V> {
    final Ticker ticker;
    ...
    public SSLSMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
    ...
    @Override // com.github.benmanes.caffeine.cache.SSLSMS, com.github.benmanes.caffeine.cache.BoundedLocalCache
