...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILW.class */
class SILW<K, V> extends SIL<K, V> {
    ...
    public SILW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
