...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WILSMW.class */
public class WILSMW<K, V> extends WILS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WILSMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
