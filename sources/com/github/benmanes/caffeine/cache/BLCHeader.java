...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/BLCHeader.class */
final class BLCHeader {
    ...
    /* compiled from: BoundedLocalCache.java */
    /* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/BLCHeader$PadDrainStatus.class */
    ...
    /* compiled from: BoundedLocalCache.java */
    /* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/BLCHeader$DrainStatusRef.class */
    static abstract class DrainStatusRef<K, V> extends PadDrainStatus<K, V> {
        ...
        public boolean shouldDrainBuffers(boolean delayable) {
            switch (drainStatus()) {
                case 0:
                    return !delayable;
                case 1:
        ...
        public void lazySetDrainStatus(int drainStatus) {
            UnsafeAccess.UNSAFE.putOrderedInt(this, DRAIN_STATUS_OFFSET, drainStatus);
        }

        public boolean casDrainStatus(int expect, int update) {
