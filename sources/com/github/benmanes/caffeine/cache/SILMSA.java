...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SILMSA.class */
public class SILMSA<K, V> extends SILMS<K, V> {
    final Ticker ticker;
    ...
    public SILMSA(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
