...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSLAW.class */
class SSLAW<K, V> extends SSLA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSLAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
