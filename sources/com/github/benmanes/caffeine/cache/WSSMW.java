...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSSMW.class */
public class WSSMW<K, V> extends WSS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public WSSMW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
