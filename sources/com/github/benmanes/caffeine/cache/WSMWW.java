...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WSMWW.class */
class WSMWW<K, V> extends WSMW<K, V> {
    ...
    public WSMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
