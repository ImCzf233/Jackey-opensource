...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSW.class */
class SSSW<K, V> extends SSS<K, V> {
    ...
    public SSSW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
