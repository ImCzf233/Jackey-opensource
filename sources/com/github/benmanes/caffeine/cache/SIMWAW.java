...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIMWAW.class */
class SIMWAW<K, V> extends SIMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SIMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
