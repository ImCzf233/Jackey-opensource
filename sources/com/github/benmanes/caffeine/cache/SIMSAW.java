...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SIMSAW.class */
class SIMSAW<K, V> extends SIMSA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SIMSAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
