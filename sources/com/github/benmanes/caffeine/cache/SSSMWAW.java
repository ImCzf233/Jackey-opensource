...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SSSMWAW.class */
class SSSMWAW<K, V> extends SSSMWA<K, V> {
    final WriteOrderDeque<Node<K, V>> writeOrderDeque = new WriteOrderDeque<>();
    volatile long expiresAfterWriteNanos;

    public SSSMWAW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
