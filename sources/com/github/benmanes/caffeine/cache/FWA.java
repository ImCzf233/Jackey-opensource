...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/FWA.class */
public class FWA<K, V> extends C0009FW<K, V> {
    ...
    public FWA(K key, ReferenceQueue<K> keyReferenceQueue, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
        super(key, keyReferenceQueue, value, valueReferenceQueue, weight, now);
        UnsafeAccess.UNSAFE.putLong(this, ACCESS_TIME_OFFSET, now);
    }

    public FWA(Object keyReference, V value, ReferenceQueue<V> valueReferenceQueue, int weight, long now) {
