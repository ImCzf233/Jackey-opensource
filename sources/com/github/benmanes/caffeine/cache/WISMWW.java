...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/WISMWW.class */
class WISMWW<K, V> extends WISMW<K, V> {
    ...
    public WISMWW(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
