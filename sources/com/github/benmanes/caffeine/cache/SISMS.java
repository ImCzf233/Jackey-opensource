...
/* loaded from: Jackey Client b2.jar:com/github/benmanes/caffeine/cache/SISMS.class */
public class SISMS<K, V> extends SIS<K, V> {
    long maximum;
    long weightedSize;
    long windowMaximum;
    ...
    public SISMS(Caffeine<K, V> builder, CacheLoader<? super K, V> cacheLoader, boolean async) {
