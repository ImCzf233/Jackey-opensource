...
/* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_7_6_10to1_8/storage/GameProfileStorage.class */
public class GameProfileStorage extends StoredObject {
    ...
    /* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_7_6_10to1_8/storage/GameProfileStorage$GameProfile.class */
            ...
            for (Property property : this.properties) {
                if (property.name.equals("textures")) {
                    ...
                    if (property.signature != null) {
                        textureTag.put(SignatureAttribute.tag, new StringTag(property.signature));
                    }
    ...
    /* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_7_6_10to1_8/storage/GameProfileStorage$Property.class */
