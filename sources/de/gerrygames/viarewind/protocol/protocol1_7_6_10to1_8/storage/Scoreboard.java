...
/* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_7_6_10to1_8/storage/Scoreboard.class */
public class Scoreboard extends StoredObject {
    ...
    public String sendTeamForScore(String score) {
        ...
        if (!this.scoreTeams.containsKey(score)) {
            ...
            String substring = score.substring(i, i + 16);
            while (true) {
                ...
                if (this.scoreTeamNames.contains(name) || this.teams.containsKey(name)) {
                    ...
                    substring = score.substring(i, i + l);
                } else {
                    ...
                    PacketWrapper teamPacket = PacketWrapper.create(62, (ByteBuf) null, getUser());
    ...
    /* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_7_6_10to1_8/storage/Scoreboard$ScoreTeam.class */
