...
/* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_7_6_10to1_8/entityreplacements/GuardianReplacement.class */
public class GuardianReplacement implements EntityReplacement {
    ...
    public void updateMetadata() {
        ...
        for (Metadata metadata : this.datawatcher) {
            if (metadata.m222id() != 16 && metadata.m222id() != 17) {
