...
/* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_8to1_9/items/ReplacementRegistry1_8to1_9.class */
public class ReplacementRegistry1_8to1_9 {
    ...
    static {
        ...
        registry.registerItem(435, new Replacement((int) TokenId.OR_E, "Beetroot Seeds"));
        registry.registerItem(436, new Replacement(282, "Beetroot Soup"));
        registry.registerItem(432, new Replacement((int) TokenId.IMPORT, "Chorus Fruit"));
        ...
        registry.registerItem(426, new Replacement((int) TokenId.TRUE, "End Crystal"));
        ...
        registry.registerItem(444, new Replacement((int) TokenId.RETURN, "Spruce Boat"));
        registry.registerItem(445, new Replacement((int) TokenId.RETURN, "Birch Boat"));
        registry.registerItem(446, new Replacement((int) TokenId.RETURN, "Jungle Boat"));
        registry.registerItem(447, new Replacement((int) TokenId.RETURN, "Acacia Boat"));
        registry.registerItem(448, new Replacement((int) TokenId.RETURN, "Dark Oak Boat"));
        ...
        registry.registerItemBlock(Opcode.JSR_W, new Replacement(155, 0, "Purpur Block"));
        ...
        registry.registerItemBlock(Typography.times, new Replacement(112, 0, "Red Nether Brick"));
    ...
    public static int replace(int raw) {
        ...
        return replace == null ? raw : BlockState.stateToRaw(replace.getId(), replace.replaceData(data));
    }
