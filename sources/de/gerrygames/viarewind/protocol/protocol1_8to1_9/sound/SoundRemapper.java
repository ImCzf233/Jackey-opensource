...
/* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_8to1_9/sound/SoundRemapper.class */
public class SoundRemapper {
    ...
    private static void register1_9Sound(String sound1_9) {
        ...
        int i = f214id;
        f214id = i + 1;
        hashMap.put(Integer.valueOf(i), sound1_9);
    }
    ...
    public static String oldNameFromId(int id) {
        String sound1_9 = sounds1_9.get(Integer.valueOf(id));
        if (sound1_9 == null) {
            return null;
        }
