...
/* loaded from: Jackey Client b2.jar:de/gerrygames/viarewind/protocol/protocol1_8to1_9/sound/Effect.class */
public class Effect {
    ...
    static {
        ...
        effects.put(Integer.valueOf((int) CharacterType.ALNUM_MASK), 1012);
        ...
        effects.put(1031, Integer.valueOf((int) CharacterType.ALNUM_MASK));
        effects.put(1032, -1);
        effects.put(1033, -1);
        effects.put(1034, -1);
        effects.put(1035, -1);
    ...
    public static int getOldId(int id) {
        return effects.getOrDefault(Integer.valueOf(id), Integer.valueOf(id)).intValue();
    }
}
