...
/* loaded from: Jackey Client b2.jar:de/enzaxd/viaforge/protocol/ProtocolCollection.class */
public enum ProtocolCollection {
    ...
    R1_13_2(new ProtocolVersion(TokenId.FloatConstant, "1.13.2")),
    R1_13_1(new ProtocolVersion(TokenId.CharConstant, "1.13.1")),
    R1_13(new ProtocolVersion(393, "1.13")),
    R1_12_2(new ProtocolVersion(TokenId.THROW, "1.12.2")),
    R1_12_1(new ProtocolVersion(TokenId.SYNCHRONIZED, "1.12.1")),
    R1_12(new ProtocolVersion(TokenId.STATIC, "1.12")),
    R1_11_1(new ProtocolVersion(TokenId.FINALLY, "1.11.1-1.11.2")),
    R1_11(new ProtocolVersion(TokenId.FINAL, "1.11")),
