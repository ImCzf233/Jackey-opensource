...
/* loaded from: Jackey Client b2.jar:org/apache/log4j/net/SyslogAppender.class */
public class SyslogAppender extends AppenderSkeleton {
    ...
    private void initSyslogFacilityStr() {
        ...
        this.facilityStr = new StringBuffer().append(this.facilityStr).append(CallSiteDescriptor.TOKEN_DELIMITER).toString();
    }
