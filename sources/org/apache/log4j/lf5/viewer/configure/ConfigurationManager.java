...
/* loaded from: Jackey Client b2.jar:org/apache/log4j/lf5/viewer/configure/ConfigurationManager.class */
public class ConfigurationManager {
    ...
    protected void processCategories(Document doc) {
        ...
        int j = getValue(nodeList.item(0).getAttributes(), NAME).equalsIgnoreCase(FIRST_CATEGORY_NAME) ? 1 : 0;
