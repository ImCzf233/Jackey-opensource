...
/* loaded from: Jackey Client b2.jar:org/spongepowered/asm/lib/tree/analysis/BasicVerifier.class */
    ...
    public BasicValue naryOperation(AbstractInsnNode insn, List<? extends BasicValue> values) throws AnalyzerException {
        ...
        if (opcode == 197) {
            ...
            while (i2 < values.size()) {
                int i3 = j;
                j++;
                BasicValue expected = newValue(args[i3]);
                int i4 = i2;
                i2++;
                BasicValue encountered = values.get(i4);
