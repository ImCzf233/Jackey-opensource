...
/* loaded from: Jackey Client b2.jar:org/spongepowered/asm/lib/tree/analysis/BasicInterpreter.class */
public class BasicInterpreter extends Interpreter<BasicValue> implements Opcodes {
    ...
    public BasicValue newOperation(AbstractInsnNode insn) throws AnalyzerException {
        switch (insn.getOpcode()) {
            case 1:
                return newValue(Type.getObjectType(Configurator.NULL));
            case 2:
            case 3:
            case 4:
            case 5:
    ...
    public BasicValue unaryOperation(AbstractInsnNode insn, BasicValue value) throws AnalyzerException {
        switch (insn.getOpcode()) {
            ...
            case 191:
                return null;
            case 192:
                String desc2 = ((TypeInsnNode) insn).desc;
                return newValue(Type.getObjectType(desc2));
            case 193:
                return BasicValue.INT_VALUE;
            case 194:
            case 195:
