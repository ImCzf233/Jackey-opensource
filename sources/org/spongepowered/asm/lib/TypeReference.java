...
/* loaded from: Jackey Client b2.jar:org/spongepowered/asm/lib/TypeReference.class */
public class TypeReference {
    ...
    public static TypeReference newSuperTypeReference(int itfIndex) {
        return new TypeReference(268435456 | ((itfIndex & CharCompanionObject.MAX_VALUE) << 8));
    }
