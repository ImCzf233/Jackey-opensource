...
/* loaded from: Jackey Client b2.jar:org/spongepowered/asm/mixin/injection/modify/LocalVariableDiscriminator.class */
public class LocalVariableDiscriminator {
    ...
    /* loaded from: Jackey Client b2.jar:org/spongepowered/asm/mixin/injection/modify/LocalVariableDiscriminator$Context.class */
    public static class Context implements PrettyPrinter.IPrettyPrintable {
        ...
        /* loaded from: Jackey Client b2.jar:org/spongepowered/asm/mixin/injection/modify/LocalVariableDiscriminator$Context$Local.class */
        public class Local {
            int ord = 0;
            String name;
            Type type;
