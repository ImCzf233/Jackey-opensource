...
/* loaded from: Jackey Client b2.jar:org/spongepowered/asm/mixin/injection/struct/Target.class */
public class Target implements Comparable<Target>, Iterable<AbstractInsnNode> {
    ...
    public String getCallbackDescriptor(Type[] locals, Type[] argumentTypes) {
        return getCallbackDescriptor(false, locals, argumentTypes, 0, ShortCompanionObject.MAX_VALUE);
    }
