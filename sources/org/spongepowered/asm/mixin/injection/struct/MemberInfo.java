...
/* loaded from: Jackey Client b2.jar:org/spongepowered/asm/mixin/injection/struct/MemberInfo.class */
public final class MemberInfo {
    ...
    public String toString() {
        ...
        String qualifier = this.matchAll ? Marker.ANY_MARKER : "";
        String desc = this.desc != null ? this.desc : "";
        String separator = desc.startsWith("(") ? "" : this.desc != null ? CallSiteDescriptor.TOKEN_DELIMITER : "";
    ...
    private static MemberInfo parse(String input, IReferenceMapper refMapper, String mixinClass) {
        ...
        boolean matchAll = name.endsWith(Marker.ANY_MARKER);
        if (matchAll) {
