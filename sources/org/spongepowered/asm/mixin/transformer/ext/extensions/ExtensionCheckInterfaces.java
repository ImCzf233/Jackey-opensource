...
/* loaded from: Jackey Client b2.jar:org/spongepowered/asm/mixin/transformer/ext/extensions/ExtensionCheckInterfaces.class */
public class ExtensionCheckInterfaces implements IExtension {
    ...
    public void postApply(ITargetClassContext context) {
        ...
        printer.add("Class: %s", className).m11hr();
        printer.add("%-32s %-47s  %s", "Return Type", "Missing Method", "From Interface").m11hr();
        ...
        if (missingMethodCount > 0) {
            printer.m11hr().add("%82s%s: %d", "", "Total unimplemented", Integer.valueOf(missingMethodCount));
