...
/* loaded from: Jackey Client b2.jar:org/spongepowered/asm/util/Bytecode.class */
public final class Bytecode {
    ...
    /* loaded from: Jackey Client b2.jar:org/spongepowered/asm/util/Bytecode$Visibility.class */
        ...
        for (AnnotationNode annotation : from) {
            if (isMergeableAnnotation(annotation)) {
                ...
                while (true) {
                    if (!iter.hasNext()) {
                        break;
                    } else if (iter.next().desc.equals(annotation.desc)) {
                        iter.remove();
                        break;
                    }
                }
