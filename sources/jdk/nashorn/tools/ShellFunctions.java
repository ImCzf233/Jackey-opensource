...
/* loaded from: Jackey Client b2.jar:jdk/nashorn/tools/ShellFunctions.class */
public final class ShellFunctions {
    ...
    private static MethodHandle findOwnMH(String name, Class<?> rtype, Class<?>... types) {
        return Lookup.f248MH.findStatic(MethodHandles.lookup(), ShellFunctions.class, name, Lookup.f248MH.type(rtype, types));
    }
}
