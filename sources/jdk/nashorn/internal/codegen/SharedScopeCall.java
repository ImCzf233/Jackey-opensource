...
/* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/codegen/SharedScopeCall.class */
public class SharedScopeCall {
    ...
    public SharedScopeCall(Symbol symbol, Type valueType, Type returnType, Type[] paramTypes, int flags) {
        this.symbol = symbol;
    ...
    public void setClassAndName(CompileUnit compileUnit, String methodName) {
