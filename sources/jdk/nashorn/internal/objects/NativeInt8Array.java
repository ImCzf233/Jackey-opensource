...
/*  JADX ERROR: NullPointerException in pass: ExtractFieldInit
    ...
    */
/* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/objects/NativeInt8Array.class */
public final class NativeInt8Array extends ArrayBufferView {
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        java.lang.NullPointerException
        */
    /* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/objects/NativeInt8Array$Constructor.class */
    final class Constructor extends ScriptFunction {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x0003: CONST, method: jdk.nashorn.internal.objects.NativeInt8Array.Constructor.<init>():void
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        java.lang.NullPointerException
        */
    /* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/objects/NativeInt8Array$Prototype.class */
    final class Prototype extends PrototypeObject {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x000A: CONST, method: jdk.nashorn.internal.objects.NativeInt8Array.Prototype.<init>():void
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:49)
            	...
            	at jadx.core.dex.nodes.ClassNode.decompile(ClassNode.java:307)
            */
        /*  JADX ERROR: Failed to decode insn: 0x0014: CONST, method: jdk.nashorn.internal.objects.NativeInt8Array.Prototype.<init>():void
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:49)
    ...
    static {
        FACTORY = new ArrayBufferView.Factory(1) { // from class: jdk.nashorn.internal.objects.NativeInt8Array.1
    ...
    /* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/objects/NativeInt8Array$Int8ArrayData.class */
    public static final class Int8ArrayData extends TypedArrayData<ByteBuffer> {
        ...
        private int getElem(int index) {
            try {
                return ((ByteBuffer) this.f275nb).get(index);
        ...
        private void setElem(int index, int elem) {
            try {
                if (index < ((ByteBuffer) this.f275nb).limit()) {
                    ((ByteBuffer) this.f275nb).put(index, (byte) elem);
                }
            } catch (IndexOutOfBoundsException e) {
                throw new ClassCastException();
            }
