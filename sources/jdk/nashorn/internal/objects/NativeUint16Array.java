...
/*  JADX ERROR: NullPointerException in pass: ExtractFieldInit
    ...
    */
/* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/objects/NativeUint16Array.class */
public final class NativeUint16Array extends ArrayBufferView {
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        java.lang.NullPointerException
        */
    /* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/objects/NativeUint16Array$Constructor.class */
    final class Constructor extends ScriptFunction {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x0003: CONST, method: jdk.nashorn.internal.objects.NativeUint16Array.Constructor.<init>():void
    ...
    /*  JADX ERROR: NullPointerException in pass: ProcessKotlinInternals
        java.lang.NullPointerException
        */
    /* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/objects/NativeUint16Array$Prototype.class */
    final class Prototype extends PrototypeObject {
        ...
        /*  JADX ERROR: Failed to decode insn: 0x000A: CONST, method: jdk.nashorn.internal.objects.NativeUint16Array.Prototype.<init>():void
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:49)
            	...
            	at jadx.core.dex.nodes.ClassNode.decompile(ClassNode.java:307)
            */
        /*  JADX ERROR: Failed to decode insn: 0x0014: CONST, method: jdk.nashorn.internal.objects.NativeUint16Array.Prototype.<init>():void
            jadx.plugins.input.java.utils.JavaClassParseException: Unsupported constant type: METHOD_HANDLE
            	at jadx.plugins.input.java.data.code.decoders.LoadConstDecoder.decode(LoadConstDecoder.java:65)
            	at jadx.plugins.input.java.data.code.JavaInsnData.decode(JavaInsnData.java:46)
            	at jadx.core.dex.instructions.InsnDecoder.lambda$process$0(InsnDecoder.java:49)
    ...
    static {
        FACTORY = new ArrayBufferView.Factory(2) { // from class: jdk.nashorn.internal.objects.NativeUint16Array.1
    ...
    /* loaded from: Jackey Client b2.jar:jdk/nashorn/internal/objects/NativeUint16Array$Uint16ArrayData.class */
    public static final class Uint16ArrayData extends TypedArrayData<CharBuffer> {
        ...
        private int getElem(int index) {
            try {
                return ((CharBuffer) this.f275nb).get(index);
        ...
        private void setElem(int index, int elem) {
            try {
                if (index < ((CharBuffer) this.f275nb).limit()) {
                    ((CharBuffer) this.f275nb).put(index, (char) elem);
                }
            } catch (IndexOutOfBoundsException e) {
                throw new ClassCastException();
            }
