...
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/injection/forge/mixins/render/MixinInventoryEffectRenderer.class */
public abstract class MixinInventoryEffectRenderer extends MixinGuiContainer {
    ...
    public void func_175378_g() {
        ...
        if (!hud.getInvEffectOffset().get().booleanValue()) {
