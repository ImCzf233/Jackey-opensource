...
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/features/module/modules/render/ItemESP.class */
    ...
    public void onRender2D(Render2DEvent event) {
        if (this.modeValue.get().equalsIgnoreCase("ShaderOutline")) {
            ...
            try {
                for (Entity entity : f362mc.field_71441_e.field_72996_f) {
                    if ((entity instanceof EntityItem) || (entity instanceof EntityArrow)) {
                        f362mc.func_175598_ae().func_147936_a(entity, event.getPartialTicks(), true);
                    }
                }
            } catch (Exception ex) {
