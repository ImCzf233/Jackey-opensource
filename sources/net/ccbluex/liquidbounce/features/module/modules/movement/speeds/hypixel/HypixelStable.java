...
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/features/module/modules/movement/speeds/hypixel/HypixelStable.class */
public class HypixelStable extends SpeedMode {
    ...
    public void onMove(MoveEvent event) {
        ...
        if (speed != null && (targetStrafe = (TargetStrafe) LiquidBounce.moduleManager.getModule(TargetStrafe.class)) != null && MovementUtils.isMoving() && !f362mc.field_71439_g.func_70090_H() && !f362mc.field_71439_g.func_180799_ab() && !f362mc.field_71474_y.field_74314_A.func_151470_d()) {
