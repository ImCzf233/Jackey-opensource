...
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/features/module/modules/movement/speeds/ncp/NCPBHop.class */
public class NCPBHop extends SpeedMode {
    ...
    public void onEnable() {
        ...
        this.level = (f362mc.field_71441_e.func_72945_a(f362mc.field_71439_g, f362mc.field_71439_g.func_174813_aQ().func_72317_d(0.0d, f362mc.field_71439_g.field_70181_x, 0.0d)).size() > 0 || f362mc.field_71439_g.field_70124_G) ? 1 : 4;
    }
    ...
    public void onMove(MoveEvent event) {
        ...
        if (round(f362mc.field_71439_g.field_70163_u - ((int) f362mc.field_71439_g.field_70163_u)) == round(0.138d)) {
            EntityPlayerSP thePlayer = f362mc.field_71439_g;
            thePlayer.field_70181_x -= 0.08d;
            event.setY(event.getY() - 0.09316090325960147d);
            thePlayer.field_70163_u -= 0.09316090325960147d;
        }
