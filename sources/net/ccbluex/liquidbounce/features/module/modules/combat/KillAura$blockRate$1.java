...
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/features/module/modules/combat/KillAura$blockRate$1.class */
final class KillAura$blockRate$1 extends Lambda implements Functions<Boolean> {
    final /* synthetic */ KillAura this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public KillAura$blockRate$1(KillAura $receiver) {
        super(0);
