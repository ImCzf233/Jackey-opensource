...
/* renamed from: net.ccbluex.liquidbounce.ui.client.altmanager.GuiAltManager$actionPerformed$5 */
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/ui/client/altmanager/GuiAltManager$actionPerformed$5.class */
final class GuiAltManager$actionPerformed$5 extends Lambda implements Functions<Unit> {
    final /* synthetic */ GuiAltManager this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuiAltManager$actionPerformed$5(GuiAltManager $receiver) {
        super(0);
