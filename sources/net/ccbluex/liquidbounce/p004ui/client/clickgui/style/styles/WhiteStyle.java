...
/* renamed from: net.ccbluex.liquidbounce.ui.client.clickgui.style.styles.WhiteStyle */
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/ui/client/clickgui/style/styles/WhiteStyle.class */
public class WhiteStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        RenderUtils.drawBorderedRect(panel.getX(), panel.getY() - 3.0f, panel.getX() + panel.getWidth(), panel.getY() + 17.0f, 3.0f, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
        if (panel.getFade() > 0) {
            RenderUtils.drawBorderedRect(panel.getX(), panel.getY() + 17.0f, panel.getX() + panel.getWidth(), panel.getY() + 19 + panel.getFade(), 3.0f, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
            RenderUtils.drawBorderedRect(panel.getX(), panel.getY() + 17 + panel.getFade(), panel.getX() + panel.getWidth(), panel.getY() + 19 + panel.getFade() + 5, 3.0f, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
        }
        GlStateManager.func_179117_G();
        float textWidth = Fonts.font35.func_78256_a("§f" + StringUtils.func_76338_a(panel.getName()));
        Fonts.font35.func_78276_b(panel.getName(), (int) (panel.getX() - ((textWidth - 100.0f) / 2.0f)), (panel.getY() + 7) - 3, Color.BLACK.getRGB());
    }
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        Gui.func_73734_a(buttonElement.getX() - 1, buttonElement.getY() - 1, buttonElement.getX() + buttonElement.getWidth() + 1, buttonElement.getY() + buttonElement.getHeight() + 1, hoverColor(buttonElement.getColor() != Integer.MAX_VALUE ? new Color(14, 159, 255) : new Color(255, 255, 255), buttonElement.hoverTime).getRGB());
        GlStateManager.func_179117_G();
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        String[] values;
        Gui.func_73734_a(moduleElement.getX() - 1, moduleElement.getY() - 1, moduleElement.getX() + moduleElement.getWidth() + 1, moduleElement.getY() + moduleElement.getHeight() + 1, hoverColor(new Color(255, 255, 255), moduleElement.hoverTime).getRGB());
        Gui.func_73734_a(moduleElement.getX() - 1, moduleElement.getY() - 1, moduleElement.getX() + moduleElement.getWidth() + 1, moduleElement.getY() + moduleElement.getHeight() + 1, hoverColor(new Color(14, 159, 255, moduleElement.slowlyFade), moduleElement.hoverTime).getRGB());
        GlStateManager.func_179117_G();
        ...
        if (!moduleValues.isEmpty()) {
            ...
            if (moduleElement.isShowSettings()) {
                if (moduleElement.getSettingsWidth() > 0.0f && moduleElement.slowlySettingsYPos > moduleElement.getY() + 6) {
                    RenderUtils.drawBorderedRect(moduleElement.getX() + moduleElement.getWidth() + 4, moduleElement.getY() + 6, moduleElement.getX() + moduleElement.getWidth() + moduleElement.getSettingsWidth(), moduleElement.slowlySettingsYPos + 2, 3.0f, Color.white.getRGB(), Color.white.getRGB());
                }
                ...
                for (Value value : moduleValues) {
                    if (value.getCanDisplay().invoke().booleanValue()) {
                        if (value instanceof BoolValue) {
                            ...
                            Fonts.font35.func_78276_b(text, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, ((BoolValue) value).get().booleanValue() ? Color.BLACK.getRGB() : new Color(120, 120, 120).getRGB());
                            ...
                            Fonts.font35.func_78276_b(listValue.openList ? "-" : Marker.ANY_NON_NULL_MARKER, (int) (((moduleElement.getX() + moduleElement.getWidth()) + moduleElement.getSettingsWidth()) - (listValue.openList ? 5 : 6)), moduleElement.slowlySettingsYPos + 2, -16777216);
                            ...
                            for (String valueOfList : listValue.getValues()) {
                                ...
                                if (listValue.openList) {
                                    ...
                                    GlStateManager.func_179117_G();
                                    Fonts.font35.func_78276_b("- " + valueOfList, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 2, (listValue.get() == null || !listValue.get().equalsIgnoreCase(valueOfList)) ? new Color(120, 120, 120).getRGB() : Color.BLACK.getRGB());
                                    moduleElement.slowlySettingsYPos += Fonts.font35.field_78288_b + 1;
                                }
                            }
                            if (!listValue.openList) {
                            ...
                            String text3 = value.getName() + ": " + round(floatValue.get().floatValue()) + floatValue.getSuffix();
                            ...
                            float valueOfSlide = drawSlider(floatValue.get().floatValue(), floatValue.getMinimum(), floatValue.getMaximum(), false, moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.slowlySettingsYPos + 14, ((int) moduleElement.getSettingsWidth()) - 12, mouseX, mouseY, new Color(7, 152, 252));
                            ...
                            String text4 = value.getName() + ": " + (value instanceof BlockValue ? BlockUtils.getBlockName(integerValue.get().intValue()) + " (" + integerValue.get() + ")" : integerValue.get() + integerValue.getSuffix());
                            ...
                            float valueOfSlide2 = drawSlider(integerValue.get().intValue(), integerValue.getMinimum(), integerValue.getMaximum(), true, moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.slowlySettingsYPos + 14, ((int) moduleElement.getSettingsWidth()) - 12, mouseX, mouseY, new Color(7, 152, 252));
                            ...
                            String text5 = value.getName() + ": " + value.get();
                            ...
                            GlStateManager.func_179117_G();
                            Fonts.font35.func_78276_b(text5, moduleElement.getX() + moduleElement.getWidth() + 6, moduleElement.slowlySettingsYPos + 4, -16777216);
