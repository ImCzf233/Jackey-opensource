...
/* renamed from: net.ccbluex.liquidbounce.ui.client.clickgui.style.styles.BlackStyle */
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/ui/client/clickgui/style/styles/BlackStyle.class */
public class BlackStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        RenderUtils.drawBorderedRect(panel.getX(), panel.getY() - 3.0f, panel.getX() + panel.getWidth(), panel.getY() + 17.0f, 3.0f, new Color(20, 20, 20).getRGB(), new Color(20, 20, 20).getRGB());
        if (panel.getFade() > 0) {
            RenderUtils.drawBorderedRect(panel.getX(), panel.getY() + 17.0f, panel.getX() + panel.getWidth(), panel.getY() + 19 + panel.getFade(), 3.0f, new Color(40, 40, 40).getRGB(), new Color(40, 40, 40).getRGB());
            RenderUtils.drawBorderedRect(panel.getX(), panel.getY() + 17 + panel.getFade(), panel.getX() + panel.getWidth(), panel.getY() + 19 + panel.getFade() + 5, 3.0f, new Color(20, 20, 20).getRGB(), new Color(20, 20, 20).getRGB());
        }
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawBorderedRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.field_78288_b + 3, 3.0f, new Color(40, 40, 40).getRGB(), new Color(40, 40, 40).getRGB());
        GlStateManager.func_179117_G();
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        Gui.func_73734_a(buttonElement.getX() - 1, buttonElement.getY() - 1, buttonElement.getX() + buttonElement.getWidth() + 1, buttonElement.getY() + buttonElement.getHeight() + 1, hoverColor(buttonElement.getColor() != Integer.MAX_VALUE ? new Color(20, 20, 20) : new Color(40, 40, 40), buttonElement.hoverTime).getRGB());
        GlStateManager.func_179117_G();
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        Gui.func_73734_a(moduleElement.getX() - 1, moduleElement.getY() - 1, moduleElement.getX() + moduleElement.getWidth() + 1, moduleElement.getY() + moduleElement.getHeight() + 1, hoverColor(new Color(20, 20, 20, moduleElement.slowlyFade), moduleElement.hoverTime).getRGB());
        GlStateManager.func_179117_G();
                ...
                for (Value value : moduleValues) {
                    if (value.getCanDisplay().invoke().booleanValue()) {
                        if (value instanceof BoolValue) {
                            ...
                            float valueOfSlide = drawSlider(floatValue.get().floatValue(), floatValue.getMinimum(), floatValue.getMaximum(), false, moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.slowlySettingsYPos + 14, ((int) moduleElement.getSettingsWidth()) - 12, mouseX, mouseY, new Color(20, 20, 20));
                            ...
                            float valueOfSlide2 = drawSlider(integerValue.get().intValue(), integerValue.getMinimum(), integerValue.getMaximum(), true, moduleElement.getX() + moduleElement.getWidth() + 8, moduleElement.slowlySettingsYPos + 14, ((int) moduleElement.getSettingsWidth()) - 12, mouseX, mouseY, new Color(20, 20, 20));
