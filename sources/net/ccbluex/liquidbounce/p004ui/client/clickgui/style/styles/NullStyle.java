...
/* renamed from: net.ccbluex.liquidbounce.ui.client.clickgui.style.styles.NullStyle */
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/ui/client/clickgui/style/styles/NullStyle.class */
public class NullStyle extends Style {
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.font35.field_78288_b + 3, modifyAlpha(ClickGUI.generateColor(), 120).getRGB());
        GlStateManager.func_179117_G();
