...
/* renamed from: net.ccbluex.liquidbounce.ui.client.hud.element.elements.Target$drawElement$1 */
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/ui/client/hud/element/elements/Target$drawElement$1.class */
final class Target$drawElement$1 extends Lambda implements Functions<Unit> {
    ...
    public Target$drawElement$1(Target $receiver, float $calcTranslateX, float $calcTranslateY, float $calcScaleX, float $calcScaleY, TargetStyle $mainStyle, EntityPlayer $convertTarget) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.$mainStyle.handleShadow(this.$convertTarget);
        GL11.glPopMatrix();
    }
}
