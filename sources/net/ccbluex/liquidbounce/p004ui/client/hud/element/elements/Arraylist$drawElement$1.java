...
/* renamed from: net.ccbluex.liquidbounce.ui.client.hud.element.elements.Arraylist$drawElement$1 */
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/ui/client/hud/element/elements/Arraylist$drawElement$1.class */
final class Arraylist$drawElement$1 extends Lambda implements Functions<Unit> {
    ...
    public Arraylist$drawElement$1(Arraylist $receiver, int[] $counter, float $textHeight, float $saturation, float $brightness, String $colorMode, int $customColor) {
        super(0);
    ...
    public final void invoke() {
        ...
        for (Object item$iv : $this$forEachIndexed$iv) {
            ...
            float f4 = xPos - (StringsKt.equals(listValue.get(), "right", true) ? 3 : 2);
            float arrayY = module.getArrayY();
            listValue2 = arraylist.rectRightValue;
            float f5 = StringsKt.equals(listValue2.get(), "right", true) ? -1.0f : 0.0f;
            ...
            RenderUtils.newDrawRect(f4, arrayY, f5, arrayY2, i);
        }
        GL11.glPopMatrix();
        this.$counter[0] = 0;
    }
