...
/* renamed from: net.ccbluex.liquidbounce.ui.client.hud.element.elements.Target$drawElement$3 */
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/ui/client/hud/element/elements/Target$drawElement$3.class */
final class Target$drawElement$3 extends Lambda implements Functions<Unit> {
    ...
    public Target$drawElement$3(Target $receiver, float $calcTranslateX, float $calcTranslateY, float $calcScaleX, float $calcScaleY, TargetStyle $mainStyle, EntityPlayer $convertTarget) {
        super(0);
    ...
    public final void invoke() {
        ...
        this.$mainStyle.handleBlur(this.$convertTarget);
        GL11.glPopMatrix();
    }
}
