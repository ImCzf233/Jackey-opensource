...
/* loaded from: Jackey Client b2.jar:net/ccbluex/liquidbounce/utils/InventoryUtils.class */
public final class InventoryUtils extends MinecraftInstance implements Listenable {
    ...
    public static int findAutoBlockBlock() {
        for (int i = 36; i < 45; i++) {
            ItemStack itemStack = f362mc.field_71439_g.field_71069_bz.func_75139_a(i).func_75211_c();
            if (itemStack != null && (itemStack.func_77973_b() instanceof ItemBlock) && itemStack.field_77994_a > 0) {
                ItemBlock itemBlock = itemStack.func_77973_b();
                Block block = itemBlock.func_179223_d();
                if (block.func_149686_d() && !BLOCK_BLACKLIST.contains(block)) {
                    return i;
                }
            }
        }
