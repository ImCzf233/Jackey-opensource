...
/* loaded from: Jackey Client b2.jar:kotlin/collections/CollectionsKt___CollectionsKt$elementAt$1.class */
final class CollectionsKt___CollectionsKt$elementAt$1 extends Lambda implements Function1<Integer, T> {
    final /* synthetic */ int $index;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CollectionsKt___CollectionsKt$elementAt$1(int $index) {
        super(1);
        this.$index = $index;
    }
