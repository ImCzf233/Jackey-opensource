...
@Annotations(message = "This class is no longer supported, do not use it.", level = DeprecationLevel.ERROR)
@Deprecated
/* loaded from: Jackey Client b2.jar:kotlin/jvm/internal/FunctionImpl.class */
