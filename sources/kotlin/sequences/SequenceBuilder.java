...
public final class SequenceBuilder<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMarkers {
    ...
    public boolean hasNext() {
        while (true) {
            ...
            step.resumeWith(Result.m1214constructorimpl(Unit.INSTANCE));
        }
    }
