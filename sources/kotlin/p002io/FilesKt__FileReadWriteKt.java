...
public class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(@NotNull File $this$readBytes) {
        ...
        th = null;
        try {
            FileInputStream input = new FileInputStream($this$readBytes);
            int offset = 0;
            ...
            if (remaining > 0) {
                ...
                if (extraByte == -1) {
                    ...
                    bArr = ArraysKt.copyInto(buffer, copyOf2, result.length, 0, extra.size());
                }
            }
            return bArr;
        } finally {
