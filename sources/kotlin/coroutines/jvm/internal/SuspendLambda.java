...
/* loaded from: Jackey Client b2.jar:kotlin/coroutines/jvm/internal/SuspendLambda.class */
public abstract class SuspendLambda extends ContinuationImpl implements FunctionBase<Object>, SuspendFunction {
    ...
    public SuspendLambda(int arity, @Nullable Continuation<Object> continuation) {
        super(continuation);
        this.arity = arity;
    }
