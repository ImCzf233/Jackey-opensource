...
/* loaded from: Jackey Client b2.jar:kotlin/coroutines/jvm/internal/ContinuationImpl.class */
public abstract class ContinuationImpl extends BaseContinuationImpl {
    ...
    public final Continuation<Object> intercepted() {
        ...
        if (continuation == null) {
            ...
            Continuation it = continuationInterceptor == null ? this : continuationInterceptor.interceptContinuation(this);
            this.intercepted = it;
            return it;
        }
        return continuation;
