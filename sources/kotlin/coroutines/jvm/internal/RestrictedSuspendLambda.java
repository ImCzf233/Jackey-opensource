...
/* loaded from: Jackey Client b2.jar:kotlin/coroutines/jvm/internal/RestrictedSuspendLambda.class */
public abstract class RestrictedSuspendLambda extends RestrictedContinuationImpl implements FunctionBase<Object>, SuspendFunction {
    ...
    public RestrictedSuspendLambda(int arity, @Nullable Continuation<Object> continuation) {
        super(continuation);
        this.arity = arity;
    }
