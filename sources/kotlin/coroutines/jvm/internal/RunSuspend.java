...
/* loaded from: Jackey Client b2.jar:kotlin/coroutines/jvm/internal/RunSuspend.class */
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m2429getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(@NotNull Object result) {
        synchronized (this) {
            setResult(Result.m1215boximpl(result));
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result result = m2429getResultxLWZpok();
                if (result == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(result.m1216unboximpl());
                }
            }
        }
    }
