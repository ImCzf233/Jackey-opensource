...
public final class ResultKt {
    ...
    private static final <R> Object runCatching(Functions<? extends R> block) {
        ...
        try {
            ...
            obj = Result.m1214constructorimpl(block.invoke());
        } catch (Throwable e) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m1214constructorimpl(createFailure(e));
        }
        return obj;
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> block) {
        ...
        try {
            Result.Companion companion = Result.Companion;
            obj = Result.m1214constructorimpl(block.invoke(t));
        } catch (Throwable e) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m1214constructorimpl(createFailure(e));
        }
    ...
    private static final <R, T extends R> R getOrElse(Object $this$getOrElse, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Throwable exception = Result.m1210exceptionOrNullimpl($this$getOrElse);
    ...
    private static final <R, T extends R> R getOrDefault(Object $this$getOrDefault, R r) {
        return Result.m1208isFailureimpl($this$getOrDefault) ? r : $this$getOrDefault;
    }
    ...
    private static final <R, T> R fold(Object $this$fold, Function1<? super T, ? extends R> onSuccess, Function1<? super Throwable, ? extends R> onFailure) {
        ...
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable exception = Result.m1210exceptionOrNullimpl($this$fold);
    ...
    private static final <R, T> Object map(Object $this$map, Function1<? super T, ? extends R> transform) {
        ...
        if (Result.m1207isSuccessimpl($this$map)) {
            Result.Companion companion = Result.Companion;
            return Result.m1214constructorimpl(transform.invoke($this$map));
        }
        return Result.m1214constructorimpl($this$map);
    }
    ...
    private static final <R, T> Object mapCatching(Object $this$mapCatching, Function1<? super T, ? extends R> transform) {
        Object obj;
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (Result.m1207isSuccessimpl($this$mapCatching)) {
            try {
                Result.Companion companion = Result.Companion;
                obj = Result.m1214constructorimpl(transform.invoke($this$mapCatching));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                obj = Result.m1214constructorimpl(createFailure(th));
            }
            return obj;
        }
        return Result.m1214constructorimpl($this$mapCatching);
    }
    ...
    private static final <R, T extends R> Object recover(Object $this$recover, Function1<? super Throwable, ? extends R> transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable exception = Result.m1210exceptionOrNullimpl($this$recover);
        if (exception == null) {
            return $this$recover;
        }
        Result.Companion companion = Result.Companion;
        return Result.m1214constructorimpl(transform.invoke(exception));
    }
    ...
    private static final <R, T extends R> Object recoverCatching(Object $this$recoverCatching, Function1<? super Throwable, ? extends R> transform) {
        Object obj;
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable exception = Result.m1210exceptionOrNullimpl($this$recoverCatching);
        if (exception == null) {
            return $this$recoverCatching;
        }
        try {
            Result.Companion companion = Result.Companion;
            obj = Result.m1214constructorimpl(transform.invoke(exception));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m1214constructorimpl(createFailure(th));
        }
    ...
    private static final <T> Object onFailure(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        ...
        Throwable it = Result.m1210exceptionOrNullimpl($this$onFailure);
        if (it != null) {
            action.invoke(it);
        }
    ...
    private static final <T> Object onSuccess(Object $this$onSuccess, Function1<? super T, Unit> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        if (Result.m1207isSuccessimpl($this$onSuccess)) {
