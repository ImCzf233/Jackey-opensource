...
/* loaded from: Jackey Client b2.jar:kotlin/text/DelimitedRangesSequence.class */
public final class Strings implements Sequence<IntRange> {
    ...
    public Strings(@NotNull CharSequence input, int startIndex, int limit, @NotNull Function2<? super CharSequence, ? super Integer, Tuples<Integer, Integer>> getNextMatch) {
