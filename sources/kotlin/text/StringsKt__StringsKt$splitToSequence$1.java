...
/* loaded from: Jackey Client b2.jar:kotlin/text/StringsKt__StringsKt$splitToSequence$1.class */
public final class StringsKt__StringsKt$splitToSequence$1 extends Lambda implements Function1<IntRange, String> {
    ...
    public StringsKt__StringsKt$splitToSequence$1(CharSequence $receiver) {
        super(1);
